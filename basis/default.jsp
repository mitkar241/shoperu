...
<%
String personalize=session.getAttribute("personalize").toString();
...
int p1=1, p2=2;
for(int i=0;i<personalize.length();i++)
{
  if('#'==personalize.charAt(i))
    p1 = i;
  if('$'==personalize.charAt(i))
    p2 = i;
}

username = personalize.substring(0, p1);
gender = personalize.substring(p1+1, p2);
preference = personalize.substring(p2+1, personalize.length());
  ...
  <table class="workspace">
    <tr>
      ...
      <td class="navigation">
        ...
        <br>
        <center>
        <form class="customise" action="custom.jsp">
          <br>
          <br>
